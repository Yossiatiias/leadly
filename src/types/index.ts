...
export const STATUS_CONFIG: Record<LeadStatus, { label: string; bg: string; text: string }> = {
  ...
  contacted:    { label: 'ביצירת קשר', bg: 'bg-amber-50',  text: 'text-amber-800' },
  in_progress:  { label: 'בתהליך',     bg: 'bg-lime-50',   text: 'text-lime-800' },
  published:    { label: 'פורסם',      bg: 'bg-green-50',  text: 'text-green-800' },
